...
def load_and_preprocess(filepath: str, sample_size: int = 15000) -> pd.DataFrame:
    """
...
def render_eda(df):
    ...
    with st.expander("📚 Detail Teknis Algoritma"):
        ...
        **Preprocessing:**
        ...
        - Smart sampling: {sample_size:,} game berdasarkan total review
...
sample_size = 15000   # global untuk dipakai di EDA expander
